...
plot_visit <- ggplot(healthcare_df, aes(x = VisitType)) +
    ...
    labs(title = "Count of Visit Types", x = "Visit Types", y = "Count")
    # Add a fill color of the categorical variable
...
plot_age_cost <- ggplot(healthcare_df, aes(x = Age, y = HealthcareCost)) +
    geom_point() +
    labs(title = "Age vs. Healthcare Cost", x = "Age", y = "Healthcare Cost")
print(plot_age_cost)
...
plot_age_cost <- ggplot(healthcare_df, aes(x = Age, y = HealthcareCost, color = Smoker)) +
    geom_point() +
    labs(title = "Cost vs Age by Smoker Status", x = "Age", y = "Healthcare Cost")
print(plot_age_cost)
...
plot_cost_by_insurance <- ggplot(healthcare_df, aes(x = InsuranceProvider, y = HealthcareCost)) +
    geom_boxplot() +
    labs(title = "Healthcare Cost by Insurance Provider", x = "Insurance Provider", y = "Healthcare Cost")
    # Create a boxplot
...
plot_visits_by_region <- ggplot(healthcare_df, aes(x = Region, y = HealthcareCost)) +
    ...
    labs(title = "Healthcare Cost by Region with Visit Types", x = "Region", y = "Healthcare Cost")
...
final_plot <- ggplot(healthcare_df, aes(x = Region, y = CostPerDay)) +
    geom_boxplot() +
    labs(title = "Per Day Cost by Region", x = "Region", y = "Cost Per Day")
